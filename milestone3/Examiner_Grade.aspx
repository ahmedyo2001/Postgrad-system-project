<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Examiner Grade.aspx.cs" Inherits="milestone3.Examiner_Grade" %>
...
<body>
    <form id="form1" runat="server">
       <asp:Label ID="Label" runat="server" Text="Examiner Comments For A Defense"></asp:Label>
        ...
        <br />
        <asp:Label ID="Grades_label" runat="server" Text="Grades"></asp:Label>
        <br />
